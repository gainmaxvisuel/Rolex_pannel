/* =========================================================
   ROLEX — ADMIN DÉPÔTS
   Fichier complet : admin-depots.js
========================================================= */
...
const cancelRejectBottom =
  document.getElementById("cancelRejectBottom");
...
async function loadDeposits() {
  ...
  try {
    ...
    /*
     * La fonction SQL retourne un JSONB.
     * Selon Supabase, data peut donc être
     * directement un tableau ou une chaîne JSON.
     */
...
function renderDeposits() {
  ...
  filteredDeposits.forEach(
    deposit => {
       ...
       * IMPORTANT :
       *
       * La preuve dépend UNIQUEMENT
       * de payment_proof_path.
       *
       * Le statut ne supprime jamais
...
async function verifyDeposit(
  ...
  const button =
    document.querySelector(
      `[data-action="verify"][data-id="${depositId}"]`
    );
  ...
  try {
    ...
    if (
      ...
      /*
       * Si le filtre actuel ne contient
       * plus le dépôt, on recharge.
       */
...
async function approveDeposit(
  ...
  const button =
    document.querySelector(
      `[data-action="approve"][data-id="${depositId}"]`
    );
  ...
  try {
    ...
    if (
      ...
      /*
       * On conserve toutes les autres
       * propriétés, notamment la preuve.
       */
...
async function rejectDeposit() {
  ...
  try {
    ...
    if (
      ...
      /*
       * On conserve payment_proof_path.
       */
...
async function viewProof(
  ...
  const button =
    document.querySelector(
      `[data-action="proof"][data-id="${depositId}"]`
    );
...
autoRefreshTimer =
  setInterval(
    () => {
      ...
      /*
       * Ne pas recharger pendant
       * que le modal de rejet est ouvert.
       */
